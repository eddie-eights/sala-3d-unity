        ...
        <div className="flex h-screen w-full items-center justify-center bg-blue-50 relative overflow-hidden">
            ...
            <div className="relative z-10 flex h-full w-full max-w-7xl items-center justify-between px-8 md:px-16">
                ...
                <div className="flex-1 flex items-center justify-center h-[80%]">
                    ...
                    <div className="relative flex h-full w-full max-w-lg items-center justify-center">
                        <UnityPlayer
                            ...
                            buildPath="/unity-build-welcome"
                            buildName="unity-build-welcome"
                        />
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center ml-12">
                    <Link href="/login" className="group relative" style={{ perspective: '800px' }}>
                        {/* Outline of a Door */}
                        <div className="relative h-[400px] w-[220px] rounded-t-full border-4 border-white/80 bg-white/30 backdrop-blur-sm shadow-lg transition-all duration-500 group-hover:bg-white/50 group-hover:-translate-y-2 group-hover:shadow-xl overflow-hidden group-hover:[transform:rotateY(15deg)]" style={{ transformOrigin: 'left center' }}>
                            {/* Door Panel */}
                        ...
                        {/* Floor Shadow */}
                        <div className="mt-8 h-4 w-[200px] rounded-[100%] bg-blue-900/10 blur-md transition-all duration-500 group-hover:blur-lg group-hover:bg-blue-900/20" />
                    </Link>
